    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-group">
        ...
        <div class="col-12">
          <select
            id="gender"
            v-model="user.gender.selected"
            class="form-control"
          >
            <option
              v-for="option in user.gender.options"
              :key="option.value"
              :value="option.value"
            >
              {{ option.text }}
      ...
      async handleSubmit(){
        if(this.id){
          ...
          */
          ...
          if (option){
            this.$http.put("http://localhost:3002/users/" + this.id, this.user)
            .then( (response) => {
          ...
          if (option){
            this.$http.post("http://localhost:3002/users/", this.user)
            .then( (response) => {
