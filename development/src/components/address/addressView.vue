 ...
 <li v-if="address.city"class="list-group-item"> <strong> city: </strong>{{address.city}}</li> 
            ...
            <div class="row">
               <div class="col">
                 <router-link class="btn btn-default" :to="{ name: 'address', params: {} }">BACK TO LIST</router-link>
                 <router-link class="btn btn-warning" :to="{ name: 'addressEdit', params: {id: id} }">EDIT</router-link>
               </div>
            </div>
          </div>
