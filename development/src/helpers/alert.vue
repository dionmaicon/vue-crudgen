    ...
    <div class="modal-wrapper">
      <div :class="[ 'modal-container', loadClass ] ">
        ...
        <div :class="[loadClass]">
          ...
          <div class="footer row"  v-if="type == 1">
            <button class="btn btn-outline-dark col"  @click="$emit('confirm', false)">Close</button>
          </div>
          <div class="footer row" v-if="type == 2">
            <button  class="btn btn-outline-dark col" @click="$emit('confirm', false)">Cancel</button>
            <button  class="btn btn-outline-success col" @click="$emit('confirm', true)">Confirm</button>
          </div>
        </div>
